...
var myStyle = function(feature) {
  switch (feature.properties.COLLDAY) {
    ...
    case 'TUE': return {color:'coral'};
    case 'WED': return {color:'lime'};
    case 'THU': return {color:'seagreen'};
    case 'FRI': return {color:'aqua'};
    default: return {fillColor: 'lightgray'};
  }
};
...
var eachFeatureFunction = function(layer) {
  layer.on('click', function (event) {
    ...
    var layerf = function(layerFeature) {
	    ...
	    $("span.day-of-week").text(layerf(layer.feature));
    showResults();
  });
};
...
$(document).ready(function() {
  $.ajax(dataset).done(function(data) {
    ...
    featureGroup = L.geoJson(parsedData, {style: myStyle, filter: myFilter}).addTo(map);
